...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JIN', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '平面设计狮', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.reading1210.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '今海, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'reading1210@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  FONT_URL: [// 字体CSS 例如 https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css
    ...
    'https://fonts.googleapis.com/css2?family=PingFang+Sans+SC:wght@300&display=swap',
  ],
  ...
  MUSIC_PLAYER_AUDIO_LIST: [ // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    ...
    },
    {
      name: '漫漫长夜',
      artist: 'deca joins',
      url: 'https://music.163.com/song/media/outer/url?id=1805380227.mp3',
      cover: 'https://i.postimg.cc/Y9vkZmqc/maxresdefault.jpg'
    }
  ],
